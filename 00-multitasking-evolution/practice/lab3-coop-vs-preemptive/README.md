...
1. ระบบไหนมีเวลาตอบสนองดีกว่า? เพราะอะไร?
    Preemptive ตอบสนองเร็วกว่า เพราะสามารถแย่ง CPU ให้ task สำคัญทำงานได้ทันที
2. ข้อดีของ Cooperative Multitasking คืออะไร?
    โครงสร้างง่าย, ไม่มีการแย่ง resource, overhead ต่ำ
3. ข้อเสียของ Cooperative Multitasking คืออะไร?
    ถ้า task หนึ่งไม่ปล่อย CPU งานอื่นจะหยุดทั้งหมด, เวลาตอบสนองไม่แน่นอน
4. ในสถานการณ์ใดที่ Cooperative จะดีกว่า Preemptive?
    ระบบเล็ก, งานไม่ซับซ้อน, ต้องการลด overhead และควบคุมลำดับเอง
5. เหตุใด Preemptive จึงเหมาะสำหรับ Real-time systems?
    ตอบสนองตามเวลาได้แน่นอน, ทำงานทันทีเมื่อเกิดเหตุการณ์, เหมาะกับระบบควบคุมจริง
